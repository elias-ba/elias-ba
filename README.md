...
I'm a senior software engineer at [OpenFn](https://openfn.org), where most of my time goes into [Lightning](https://github.com/openfn/lightning), an open-source workflow engine used by governments, NGOs, and public health institutions to integrate fragile systems and automate processes where failure has real human cost. The work sits at a boundary I find endlessly interesting: between what is technically elegant and what is operationally necessary. These are rarely the same thing, and learning to navigate that tension is most of what senior engineering actually is.

Before and alongside that, I've spent years working at the intersection of AI, systems design, and education. I built [ask](https://github.com/elias-ba/ask), a CLI tool that brings LLMs into the terminal where developers already think. I built [tyrex](https://github.com/elias-ba/tyrex), a genetic programming library in Elixir, because I believe evolutionary computation is underexplored and Elixir's concurrency model is quietly revolutionary for it. I've written [courses on deep learning](https://github.com/elias-ba/deep-learning-course), [visualized algorithms](https://github.com/elias-ba/algo-visualizer) to make them legible, and built small tools that solve one problem well - because I think the best software disappears into the workflow.

I founded [GalsenAI](https://galsen.ai) to grow the AI and software engineering ecosystem in Senegal. Not to replicate Silicon Valley, but to build something that makes sense for our context - where constraints are different, where infrastructure can't be assumed, and where the problems worth solving don't always look like the ones in the textbooks. I teach, I mentor, and I try to make the path shorter for those coming after me.
